 ...
 *=====================================================================================*/
static void sso_dehyd_init(void);
 ...
 *=====================================================================================*/
union Dispatcher_Class SSO_Dehyd_Ctl_Worker_Class =
{
...
void Populate_SSO_Dehyd_Worker(union SSO_Dehyd_Worker * const this)
{
   if(NULL == SSO_Dehyd_Worker.vtbl)
   {
      ...
      Object_Init(&SSO_Dehyd_Ctl_Worker.Object, &SSO_Dehyd_Ctl_Worker_Class.Class,
   ...
   memcpy(this, &SSO_Dehyd_Worker, sizeof(SSO_Dehyd_Worker));;
}
/*=====================================================================================* 
 * sso_dehyd_worker.c
 *=====================================================================================*
