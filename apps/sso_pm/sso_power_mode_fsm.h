...
FSM_STATE_DEF(cb, SSO_PM_IDLE_STID, \
     FSM_TRANSITION_DEF(cb, SSO_PM_INT_POWER_ACQUIRE_REQ_MID, SSO_PM_IDLE_STID,  SSO_PM_Subscribe_Handle) \
     FSM_TRANSITION_DEF(cb, SSO_PM_INT_POWER_RELEASE_REQ_MID, SSO_PM_IDLE_STID,  SSO_PM_Unsubscribe_Handle) \
     FSM_TRANSITION_DEF(cb, SSO_PM_INT_12VDC_INIT_MID,        SSO_PM_12VDC_STID, SSO_PM_Init_12VDC_Source) \
     FSM_TRANSITION_DEF(cb, SSO_PM_INT_120AC_INIT_MID,        SSO_PM_IDLE_STID,  SSO_PM_Init_120AC_Source) \
     FSM_TRANSITION_DEF(cb, SSO_PM_INT_SHUTDOWN_MID,          SSO_PM_SHUT_STID,  SSO_PM_Shut_All) \
     ) \
FSM_STATE_DEF(cb, SSO_PM_12VDC_ON_STID, \
     FSM_TRANSITION_DEF(cb, SSO_PM_INT_POWER_ACQUIRE_REQ_MID, SSO_PM_12VDC_STID, SSO_PM_Subscribe_Handle) \
     FSM_TRANSITION_DEF(cb, SSO_PM_INT_POWER_RELEASE_REQ_MID, SSO_PM_12VDC_STID, SSO_PM_Unsubscribe_Handle) \
...
FSM_STATE_DEF(cb, SSO_PM_120AC_ON_STID, \
     FSM_TRANSITION_DEF(cb, SSO_PM_INT_POWER_ACQUIRE_REQ_MID, SSO_PM_120AC_STID, SSO_PM_Subscribe_Handle) \
     FSM_TRANSITION_DEF(cb, SSO_PM_INT_POWER_RELEASE_REQ_MID, SSO_PM_120AC_STID, SSO_PM_Unsubscribe_Handle) \
...
FSM_STATE_DEF(cb, SSO_PM_SHUT_STID, \
     FSM_TRANSITION_DEF(cb, SSO_PM_INT_POWER_RELEASE_REQ_MID, SSO_PM_SHUT_STID,  SSO_PM_Unsubscribe_Handle) \
     FSM_TRANSITION_DEF(cb, SSO_PM_INT_12VDC_SHUT_MID,        SSO_PM_IDLE_STID,  SSO_PM_Shut_12VDC_Source) \
     FSM_TRANSITION_DEF(cb, SSO_PM_INT_120AC_SHUT_MID,        SSO_PM_IDLE_STID,  SSO_PM_Shut_120AC_Source) \
