...
#define SNACK_GPIO_ADC_TEMP_AVG      (ARDUINO_ADC_CHANNEL_0) /*ARDUINO_DIO_CHANNEL_14*/
#define SNACK_GPIO_ADC_LIGHT_AVG     (ARDUINO_ADC_CHANNEL_1) /*ARDUINO_DIO_CHANNEL_15*/
#define SNACK_GPIO_ADC_FAN_OUT       (ARDUINO_ADC_CHANNEL_2) /*ARDUINO_DIO_CHANNEL_16*/
